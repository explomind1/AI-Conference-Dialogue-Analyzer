...
# import csv
# import urllib.parse
# from firebase_admin import credentials as firebase_credentials, firestore, initialize_app, get_app
# import config
...
#         cred = firebase_credentials.Certificate(firebase_cred)
...
#     BUCKET_NAME = 'explomindvotingcredentials'
#     KEY = "AOI_clientsecret.json"
#     local_file_name = '/tmp/' + KEY
#     s3_client.download_file(BUCKET_NAME, KEY, local_file_name)

#     # Set up Google Sheets API client
#     google_scopes = ["https://www.googleapis.com/auth/drive", "https://www.googleapis.com/auth/drive.file", "https://www.googleapis.com/auth/spreadsheets"]
#     google_credentials = service_account.Credentials.from_service_account_file(local_file_name, scopes=google_scopes)
#     service = build('sheets', 'v4', credentials=google_credentials)

#     # Fetch data from the spreadsheet
#     spreadsheet_id = '1HtN7B7DMPMt55ILVctK2QFG4PRjpXnNoefkEgvbs2Kw'
...
#     # Output CSV format for each group
#     bucket_name = 'aoiaiwhatsappdata1'
...
#             if len(item) > 3:
#                 writer.writerow([index + 1, item[3], " ".join(item[2:4])])  # Assuming phone number is at index 3
#             else:
#                 writer.writerow([index + 1, "Data Missing", "Data Missing"])
...
#     email_sender = 'tradeopportunity@explomind.academy'
